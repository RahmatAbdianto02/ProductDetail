package com.dicoding.picodiploma.productdetail.format
...
fun String.withCurrencyFormat(): String {
    ...
    var mcCurrencyFormat = NumberFormat.getCurrencyInstance()
    ...
    when {
        ...
        deviceLocale.equals("ID") -> {
            ...
            mcCurrencyFormat = NumberFormat.getCurrencyInstance(Locale.US)
        }
    }

    return mcCurrencyFormat.format(priceOnDollar)
}
